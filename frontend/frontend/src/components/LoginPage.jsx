  ...
  return (
    <div className="bg-gray-50 text-gray-800">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <section className="w-full max-w-md mx-auto md:w-auto">
          ...
          <form action={formAction} className="mt-6 space-y-4">
            <div>
              ...
              <input type="text" name='username' placeholder="Enter your email" className="mt-1 w-full rounded border border-gray-300 px-3 py-2 focus:border-blue-600 focus:ring-1 focus:ring-blue-200 outline-none" />
            </div>
            ...
            <div>
              ...
              <input type="password" name='password' placeholder="Enter your password" className="mt-1 w-full rounded border border-gray-300 px-3 py-2 focus:border-blue-600 focus:ring-1 focus:ring-blue-200 outline-none" />
            </div>
